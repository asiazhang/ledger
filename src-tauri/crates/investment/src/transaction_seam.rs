...
//! [`InvestmentPlan`](ledger_transaction::seams::investment::InvestmentPlan) 与命令
...
use ledger_transaction::seams::investment::{
...
impl ledger_transaction::seams::investment::InvestmentPlan for Plan {
