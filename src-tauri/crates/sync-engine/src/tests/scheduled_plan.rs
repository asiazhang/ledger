...
use tauri_app_lib::test_support::seed_account;

fn plan_input(account_id: &str, start_date: &str) -> ledger_scheduled::CreateScheduledInput {
...
fn plan_lifecycle_ops_replay_and_converge() {
    ...
    update_subscription(
        &conn_a,
        ledger_scheduled::UpdateSubscriptionInput {
            id: plan_id.clone(),
