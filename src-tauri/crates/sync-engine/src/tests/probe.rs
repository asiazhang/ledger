...
use crate::{SyncChannelConfig, probe_channel};
...
fn probe_treats_missing_object_as_connected_and_reads_only() {
    ...
    let config = crate::tests::common::stub_channel_config(&stub, "family");
...
fn probe_reports_credentials_rejected_for_invalid_access_key() {
    ...
    let err = probe_channel(&crate::tests::common::stub_channel_config(&stub, "family"))
        .expect_err("无效密钥应被拒");
