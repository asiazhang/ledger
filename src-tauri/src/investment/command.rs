...
pub(crate) fn replay_instrument_command(
    conn: &Connection,
...
pub(crate) fn replay_exchange_rate_command(
    conn: &Connection,
...
pub(crate) fn replay_price_command(conn: &Connection, command: &PriceCommand) -> Result<()> {
    match command {
