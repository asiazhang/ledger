...
let raw_multi = r##"crate::commands::hidden with "quote" and // not comment"##;
let raw_multi_deep = r###"commands::hidden with "# and // not comment"###;
let raw_byte = br#"crate::commands::hidden with "quote" and // not comment"#;
let raw_byte_multi = br##"db::write("BEGIN"); # not delimiter"##;
