 ...
 * issue #472 / ADR-0063：保单按域归位资产组「更多」（GroupMoreView）；实物资产
 * （issue #466 / ADR-0064，诞生于全局收容器尚存的中间态）随域归位资产组「更多」；
 * 本页仅剩商户页签。全局「更多」固定项本票保留，待 #473 退役（/more 转重定向记录）。
...
const activeTab = computed<MoreTab>(() =>
  isMoreTab(route.query.tab) ? route.query.tab : 'merchants',
)
