...
| # | 分域 | 文件 | 条目主题 |
|---|------|------|----------|
| 1 | 核心交易 | [`docs/contexts/CONTEXT-core.md`](docs/contexts/CONTEXT-core.md) | Transaction、TransactionInput 装配器、InvolvingAccount、出资账户、Amount Model、Transaction Kind Mapping、债权债务往来（借出/借入）、Category、Merchant、DefaultCurrency、TransactionSearch、错误码、数字分组、耗时日志、慢查询 |
