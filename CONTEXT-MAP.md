...
| # | 分域 | 文件 | 条目主题 |
|---|------|------|----------|
| 1 | 核心交易 | [`docs/contexts/CONTEXT-core.md`](docs/contexts/CONTEXT-core.md) | Transaction、InvolvingAccount、Amount Model、Transaction Kind Mapping、Category、Merchant、DefaultCurrency、TransactionSearch、万分位分组、耗时日志、慢查询 |
